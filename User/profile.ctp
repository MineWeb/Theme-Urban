...
<div id="content" class="clearfix">
  <div class="container">
    <div class="row">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" class="input-profil form-control" value="<?= $user['pseudo'] ?>" disabled>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label><?= $Lang->get('USER__EMAIL') ?></label>
                <input type="text" class="input-profil form-control" value="<?= $user['email'] ?>" disabled>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" class="input-profil form-control" value="<?= $rank ?>" disabled>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label><?= $Lang->get('IP') ?></label>
                <input type="text" class="input-profil form-control" value="<?= $user['ip'] ?>" disabled>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <?php if($EyPlugin->isInstalled('eywek.shop.1')) { ?>
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="input-profil form-control" value="<?= $user['money'] ?>" disabled>
                </div>
              </div>
            <?php } ?>
          </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="password" class="input-profil form-control" name="password">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label><?= $Lang->get('USER__PASSWORD_CONFIRM') ?></label>
                  <input type="password" class="input-profil form-control" name="password_confirmation">
                </div>
              </div>
            </div>
            <div class="text-center">
              <button type="submit" class="btn-send-profil btn btn-template-main"><i class="fa fa-save"></i> <?= $Lang->get('GLOBAL__SUBMIT') ?></button>
            </div>
          </form>
        </div>
            ...
            <form method="post" data-ajax="true" action="<?= $this->Html->url(array('plugin' => null, 'controller' => 'user', 'action' => 'change_email')) ?>">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label><?= $Lang->get('USER__EMAIL') ?></label>
                    <input type="email" class="input-profil form-control" name="email">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label><?= $Lang->get('USER__EMAIL_CONFIRM_LABEL') ?></label>
                    <input type="email" class="input-profil form-control" name="email_confirmation">
                  </div>
                </div>
              </div>
              <div class="text-center">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="input-profil form-control" name="to">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label><?= $Lang->get('SHOP__USER_POINTS_TRANSFER_HOW_MANY') ?></label>
                    <input type="text" class="input-profil form-control" name="how">
                  </div>
                </div>
              </div>
              <div class="text-center">
                <button type="submit" class="btn-send-profil btn btn-template-main"><i class="fa fa-share"></i> <?= $Lang->get('GLOBAL__SUBMIT') ?></button>
              </div>
            </form>
          </div>
        <?php } ?>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <form method="post" data-ajax="true" action="<?= $this->Html->url(array('controller' => 'api', 'action' => 'add_ip')) ?>" data-callback-function="addIP">
                  <div class="form-group">
                    <input type="text" class="input-profil form-control" name="ip" placeholder="<?= $Lang->get('IP') ?>">
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn-send-profil btn btn-success"><?= $Lang->get('GLOBAL__ADD') ?></button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <?php if($can_skin) { ?>
          <div class="box clearfix no-mb">
            ...
            <form class="form-inline" method="post" id="skin" method="post" data-ajax="true" data-upload-image="true" action="<?= $this->Html->url(array('action' => 'uploadSkin')) ?>">
  					  ...
  					  <button type="submit" class="btn-send-profil btn btn-template-main"><?= $Lang->get('GLOBAL__SUBMIT') ?></button>
            </form>
          </div>
        <?php } ?>
        <?php if($can_cape) { ?>
      ...
      <div class="col-md-3">
        <div style="border:none;text-align: center;font-family: 'Oxygen', sans-serif;" class="panel panel-default sidebar-menu">
          <div class="panel-heading">
              <h3 style="font-family: 'Montserrat Subrayada', sans-serif;" class="panel-title">Actions</h3>
          </div>
          <div class="panel-body">
            <ul class="nav nav-pills nav-stacked">
              <li class="active">
                <a class="btn-profil" style="color:black; background: transparent;" href="#"><i class="fa fa-list"></i> <?= $Lang->get('USER__PROFILE') ?></a>
              </li>
              <?php if($EyPlugin->isInstalled('eywek.shop.1')) { ?>
                <li><a class="btn-profil" style="color:black; background: transparent;" href="<?= $this->Html->url(array('controller' => 'shop', 'action' => 'index', 'plugin' => 'shop')) ?>"><i class="fa fa-money"></i> <?= $Lang->get('SHOP__ADD_MONEY') ?></a></li>
              <?php } ?>
              <li>
                <a class="btn-profil" style="color:black; background: transparent;" href="<?= $this->Html->url(array('controller' => 'user', 'action' => 'logout', 'plugin' => false)) ?>"><i class="fa fa-sign-out"></i> <?= $Lang->get('USER__LOGOUT') ?></a>
              </li>
            </ul>
          </div>
        </div>
